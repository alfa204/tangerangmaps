...
public class PhonePln extends GDActivity{
    /** Called when the activity is first created. */
    @Override
    protected void onCreate(Bundle bundle){
		super.onCreate(bundle);
		
        setActionBarContentView(R.layout.phonepln);
        setTitle("PLN");
    }
    public void btnEvent(View v){
		...
		case R.id.btnPln01:
			kePhone("tel:+62215372708");
			break;
		
		case R.id.btnPln02:
			kePhone("tel:+62217440802");
			break;
		
		case R.id.btnPln03:
			kePhone("tel:+62217428974");
			break;
